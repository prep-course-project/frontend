...
function SelectBasicExample({data,checkHeading,handleChange,actionType}) {
  ...
  return (
    <Form.Select style={{width:'200px',display:'flex'}} onChange={(e)=>handleChange(actionType,e.target.value)} aria-label="Default select example">
      <option value="">{checkHeading}</option>
